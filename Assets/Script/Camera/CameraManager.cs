...
public class CameraManager : MonoBehaviour
{
    ...
    private Vector3 _profileTranstionStartPosition;
    ...
    {
        if (_currentCameraProfile.UseDampingHorizontaly)
        {
        ...
        if (_currentCameraProfile.UseDampingVertictally)
        {
    ...
    private void _SetCameraDampedPostion(Vector3 position)
    {
        _dampedPosition.x = position.x;
        _dampedPosition.y = position.y;
    }
    ...
    {
        _profileTranstionStartPosition = _camera.transform.position;
    ...
    private void _InitToDefaultProfile()
    {
        ...
        _SetCameraPosition(_currentCameraProfile.Position);
        _SetCameraSize(_currentCameraProfile.CameraSize);
        _SetCameraDampedPostion(_ClampPositionIntoBounds(_FindCameraNextPosition()));
    }
    ...
    public void EnterProfile(CameraProfile cameraProfile, CameraProfileTransition transition = null)
    {
        ...
        _SetCameraDampedPostion(_FindCameraNextPosition());
    }
    ...
    {
        float percent = _profileTransitionTimer / _profileTransitionDuration;
        Vector3 origin = _profileTranstionStartPosition;
